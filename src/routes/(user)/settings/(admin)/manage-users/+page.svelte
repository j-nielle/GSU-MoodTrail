...
<div class="p-10 ring-1 bg-white w-fit shadow-md drop-shadow-md rounded z-10">
	<div class="relative w-full flex items-center space-x-8">
		<caption
			class="text-xl my-3 font-bold text-left w-max text-gray-900 dark:text-white dark:bg-gray-800"
		>
			List of Users
		</caption>
		<div>
	...
	<div class="w-full mt-4">
		<Table
			divClass="text-left text-sm w-full text-gray-500 border border-zinc-300 dark:text-gray-400 max-h-72 overflow-y-auto"
		>
